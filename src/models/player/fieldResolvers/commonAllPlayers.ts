...
export const commonAllPlayers: PlayerResolvers<NbaContext>["commonAllPlayers"] =
  async (parent, _args, { dataSources }) => {
    const players = await dataSources.nbaAPI.commonAllPlayers();
    console.log("players", players);
    return [];
  };

// export const commonAllPlayers1 = async (parent, args, contextValue, info) => {
//   const players = [];
